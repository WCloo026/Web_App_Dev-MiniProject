    ...
    <div class="container">
        <div class="footer-grid">
            <div class="footer-section">
                <h3>
                    <img src="<?= $base ?>assets/images/Logo.jpeg" alt="Logo" style="height: 50px; width: auto;">
            ...
            <div class="footer-section">
                ...
                <div class="social-links">
                    ...
                    <a href="https://www.tiktok.com/en/" target="_blank" rel="noopener"><i class="fab fa-tiktok"></i></a>
                </div>
            </div>
        </div>
...
<nav class="mobile-nav">
    ...
    <?php if (isset($_SESSION['user_id'])): ?>
        <a href="<?= $base ?>pages/customer/dashboard.php"><i class="fas fa-user"></i><span>Account</span></a>
    <?php else: ?>
