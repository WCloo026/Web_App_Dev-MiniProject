...
<body>
    ...
    <main class="order-status-page">
        <div class="container">
            ...
            <!-- Status Display (shown after search) -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Auto-search if order_id in URL
            ...
            function searchOrder() {
                ...
                fetch(`../../backend/api/orders.php?action=status&order_id=${encodeURIComponent(orderId)}`)
                    ...
                    .catch(() => {
                        // For demo/frontend-only mode, show placeholder
                        document.getElementById('statusResult').style.display = 'none';
                        document.getElementById('statusNotFound').style.display = 'block';
                    });
            }
            ...
            function updateProgressSteps(status) {
                ...
                steps.forEach((step, i) => {
                    ...
                    if (i <= statusIndex) {
                        ...
                        if (i === statusIndex) el.classList.add('step-active');
                    }
                    if (line && i < statusIndex) line.classList.add('line-done');
                });
            }
        });
    </script>
