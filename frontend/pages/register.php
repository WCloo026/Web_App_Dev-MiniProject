...
<head>
    ...
    <style>
        ...
        .auth-header p  { color: #777; font-size: 0.875rem; }
        ...
        .checkbox-label input[type="checkbox"] { accent-color: #c0392b; width: 15px; height: 15px; margin-top: 2px; }
        .checkbox-label a { color: #c0392b; text-decoration: none; }
        .btn-auth {
            padding: 13px; background: #c0392b; color: #fff; border: none;
